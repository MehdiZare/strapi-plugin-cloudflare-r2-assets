...
const index = {
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsStatusPage-Nm9Ky0q9.mjs"),
      permissions: [
        {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-6tJiV7xS.mjs"), "./translations/fr.json": () => import("./fr-Di9u9orz.mjs") }), `./translations/${locale}.json`, 3);
          return {
